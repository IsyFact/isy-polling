...
image::konzept/polling-loadbalancer-jmx.png[align="center",width=50%,pdfwidth=50%]
...
image::konzept/polling-nachrichten-tabelle.png[align="center",width=50%,pdfwidth=50%]
