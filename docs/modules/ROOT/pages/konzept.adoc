...
In xref:glossary::terms-definitions.adoc#glossar-geschaeftsanwendung[Geschäftsanwendung] und xref:glossary::terms-definitions.adoc#glossar-service-gateway[Service-Gateway] müssen manchmal Polling-basierte Schnittstellen angesprochen werden.
...
image::konzept/polling_loadbalancer-einfach.png[align="center", width=55%]
...
image::konzept/polling-loadbalancer-jmx.png[align="center",width=50%]
...
image::konzept/polling-nachrichten-tabelle.png[align="center",width=50%]

Näheres zu den Nutzungsvorgaben des Bausteins findet sich in den xref:nutzungsvorgaben/master.adoc[].
