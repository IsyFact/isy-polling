...
public class PollingMBean {
     ...
     */
    private static final Logger LOG = LoggerFactory.getLogger(PollingMBean.class);
     ...
     *
     * @param pollingVerwalter der Attributwert.
     */
     ...
     *
     * @param clusterId Neuer Wert für clusterId
     */
